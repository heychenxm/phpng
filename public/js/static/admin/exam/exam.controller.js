 ...
 * @Last Modified time: 2017-08-10 14:35:20
*/
...
(function () {
    ...
    controller.$inject = [
        ...
        'api.ajax.exam',
        'app.static.admin.exam.actions.create-question',
        'app.static.admin.exam.actions.create-paper',
    ];
